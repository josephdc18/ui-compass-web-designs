#!/usr/bin/env node
/**
 * Screenshot content-kit/facebook-profile.html at 1080×1080 via Browserless.
 */
...
const HTML_PATH = resolve(ROOT, "content-kit/facebook-profile.html");
const OUT_PATH = resolve(ROOT, "content-kit/facebook-profile.png");
