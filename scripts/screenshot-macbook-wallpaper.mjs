#!/usr/bin/env node
/**
 * Screenshot content-kit/macbook-wallpaper.html at 3456×2160 via Browserless.
...
const HTML_PATH = resolve(ROOT, "content-kit/macbook-wallpaper.html");
const OUT_PATH = resolve(ROOT, "content-kit/macbook-wallpaper.png");
...
const res = await fetch(`${BASE}/screenshot?token=${encodeURIComponent(TOKEN)}`, {
  ...
  body: JSON.stringify({
    ...
    viewport: { width: 3456, height: 2160, deviceScaleFactor: 1 },
